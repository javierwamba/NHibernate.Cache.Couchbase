...
<hibernate-configuration xmlns="urn:nhibernate-configuration-2.2">
  <session-factory>
    ...
    <property name="connection.connection_string">Password=test;Persist Security Info=True;User ID=test;Initial Catalog=cacheCouchbase;Data Source=localhost</property>
    <property name="current_session_context_class">web</property>
    <property name="command_timeout">0</property>
    <property name="query.substitutions">true 1, false 0, yes 'Y', no 'N'</property>
    <property name="default_schema">cacheCouchbase.dbo</property>
